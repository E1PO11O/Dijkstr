...
namespace Dijkstra
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Indice del nodo inicio");
            dato = Console.ReadLine();
            inicio = Convert.ToInt32(dato);

            Console.WriteLine("Indice del nodo final");
            dato = Console.ReadLine();
            ...
            do
            {
                ...
                // El nuevo nodo con la menor distancia que no ha sido visitado
